 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ProgramTypeRepository")
 */
class ProgramType {
    ...
    /**
     * One ProgramType has Many ProgramTypeChoiceRules.
     * @ORM\OneToMany(targetEntity="ProgramTypeChoiceRule", mappedBy="programtype")
     */
